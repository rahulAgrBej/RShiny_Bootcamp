...
We will be creating a web application with R and the RShiny and tidyverse packages. Our web application with serve to visualize and present data from the Inter-American Development Bank. Here is a <a href='https://rahulab.shinyapps.io/RShiny_data_analytics_example/'>link</a> to finished version of the application we will be creating.
